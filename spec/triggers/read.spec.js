...
//             expect(sftp.close).toHaveBeenCalled();
//
//             expect(client.mkdir).toHaveBeenCalledWith("/.elasticio_processed",
//             { mode: 16877 }, jasmine.any(Function));
//
//
//             expect(client.rename).toHaveBeenCalled();
//
...
//             expect(sftp.close).toHaveBeenCalled();
//
//             expect(client.mkdir).toHaveBeenCalledWith("/verylongdirectoryname/.elasticio_processed",
//             { mode: 16877 }, jasmine.any(Function));
//
//
//             expect(client.rename).toHaveBeenCalled();
