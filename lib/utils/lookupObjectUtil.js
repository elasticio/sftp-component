...
class SftpLookupObject extends LookupObjectById {
  ...
  async lookupObject(filePath, cfg) {
    ...
    if (emitFileContent) {
      ...
      const base64ContentAndDescription = await getFileContentInBase64(this, file, directory);
      return messages.newMessageWithBody({ base64Content: base64ContentAndDescription });
    }
